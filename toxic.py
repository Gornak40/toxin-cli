...
if __name__ == '__main__':
	parser = ArgumentParser(prog='toxic', description='console torrent search engine')
	parser.add_argument('film', nargs='+', help='just the film name you interested without \"')
